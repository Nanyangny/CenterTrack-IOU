...
def load_model(model, model_path, opt, optimizer=None, freeze_layers =False):
    start_epoch = 0
    ...
    ## freeze all the layers except for tracking_wh head
    # if train_tracking_wh_only:
    #     excluded_layers = ['tracking_wh']
    ...
    # print(model)
    print("name of parameters for updates")
    # for name, param in model.named_parameters():
