...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='mot',
                                 help='see lib/dataset/dataset_facotry for ' +
                                      'available datasets')
        self.parser.add_argument('--test_dataset', default='',
                                 help='coco | kitti | coco_hp | pascal')
        self.parser.add_argument('--exp_id', default='MOT17_tracking_only')
        ...
        self.parser.add_argument('--demo', default='',
                                 help='path to image/ image folders/ video.'
                                      'or "webcam"')
        # self.parser.add_argument('--load_model', default='/home/students/acct1001_05/CenterTrack_MOT_Paper/models/mot17_half.pth',
        ...
        self.parser.add_argument('--resume', action='store_true',
                                 help='resume an experiment. '
                                      ...
                                      'in the models dir if load_model is empty.')
        ...
        # association methods
        self.parser.add_argument('--second_matching', action='store_true')
        self.parser.add_argument('--combined', action='store_true')
        self.parser.add_argument('--iou_first', action='store_true')
        ...
        # Tracking
        self.parser.add_argument('--direct_wh', action='store_true')
        self.parser.add_argument('--tracking', action='store_true')
        self.parser.add_argument('--tracking_wh', action='store_true')
        self.parser.add_argument('--iou', action='store_true')
        ...
        self.parser.add_argument('--apr', action='store_true')
        self.parser.add_argument('--size_comparison', action='store_true')
        self.parser.add_argument('--wh_sum', action='store_true')
        ...
        self.parser.add_argument('--size_thresh', type=float, default=1)
        self.parser.add_argument('--apr_thresh', type=float, default=0.8)
        ...
        self.parser.add_argument('--track_age', action='store_true')
        self.parser.add_argument('--direct_box', action='store_true')
        self.parser.add_argument('--track_age_cut', type=int, default=5)



        # loss
        self.parser.add_argument('--tracking_weight', type=float, default=1)
        self.parser.add_argument('--tracking_wh_weight', type=float, default=1)   ### TODO to change to 0.1
        self.parser.add_argument('--iou_weight', type=float, default=1)
        self.parser.add_argument('--tracking_ltrb_amodal', action='store_true')
        self.parser.add_argument('--tracking_ltrb_amodal_weight', type=float, default=0.1)
        self.parser.add_argument('--tracking_ltrb_amodal_offset', action='store_true')
    ...
    def parse(self, args=''):
        ...
        opt.data_dir = os.path.join(opt.root_dir,'..','Dataset')
        opt.exp_dir = os.path.join(opt.root_dir, 'models', opt.task)
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        if 'tracking' in opt.task:
            if opt.tracking_wh:
                opt.heads.update({'tracking': 2,'tracking_wh':2})
            else:
                opt.heads.update({'tracking': 2})
        if opt.iou:
            opt.heads.update({'iou':1})
        if opt.tracking_ltrb_amodal:
            opt.heads.update({'tracking_ltrb_amodal':4})
        ...
        weight_dict = {'hm': opt.hm_weight, 'wh': opt.wh_weight,
                       ...
                       'tracking_wh': opt.tracking_wh_weight,
                       'tracking_ltrb_amodal': opt.tracking_ltrb_amodal_weight if not opt.tracking_ltrb_amodal_offset else 1,
                       'iou': opt.tracking_wh_weight,
